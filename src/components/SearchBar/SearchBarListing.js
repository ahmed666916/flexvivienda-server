...
import { FaFilter, FaSearch, FaDoorOpen } from 'react-icons/fa';
import { FaWifi, FaUtensils, FaSoap, FaTshirt, FaSnowflake, FaFireAlt, FaLaptop, FaTv, FaBath, FaSwimmingPool, FaCar, FaChargingStation, FaBaby, FaBed, FaDumbbell, FaHotTub, FaCoffee, FaSmoking, FaDog, FaHome, FaBuilding, FaHotel, FaBell, FaExclamationTriangle } from 'react-icons/fa';
    ...
    <div className={`search-bar-container-listing  ${className}`}>
      ...
      <section className="search-bar-listing">
        ...
        <div className="button-row">
            <Link to="/listing">
            <button className="search-btn">  <FaSearch style={{ marginRight: '5px', fontSize:'20px' }} /> Search</button>
            </Link>
